...
struct BlockVertex
{
  ...
  BlockVertex(glm::vec3 _position, glm::vec3 _normal, glm::vec2 _texCoord)
...
struct BlockQuad
{
  ...
  BlockQuad(const glm::vec3 positions[4], const glm::vec2 texCoords[4])
  {
    ...
    vertices[0] = BlockVertex(positions[0], normal, texCoords[0]);
    vertices[1] = BlockVertex(positions[1], normal, texCoords[1]);
    vertices[2] = BlockVertex(positions[2], normal, texCoords[2]);
    vertices[3] = BlockVertex(positions[3], normal, texCoords[3]);
  }
