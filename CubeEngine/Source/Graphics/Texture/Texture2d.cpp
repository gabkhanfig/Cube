...
Texture2dAtlasData Texture2d::CreateTexture2dAtlas(const darray<const uint8*>& images, int bytesPerImageFile, int width, int height, int bitsPerPixel)
{
	...
	for (int i = 0; i < imageCount; i++) {
		uint8* imageBuffer = LoadPngToBytes(images[i], bytesPerImageFile, bitsPerPixel);
